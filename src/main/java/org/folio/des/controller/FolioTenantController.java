...
import org.folio.des.service.test.TestJobRunnerService;
...
public class FolioTenantController extends TenantController {
  ...
  private final TestJobRunnerService testJobRunnerService;
  ...
  public FolioTenantController(TenantService baseTenantService, FolioExecutionContextHelper contextHelper,
                               ...
                               EdifactScheduledJobInitializer edifactScheduledJobInitializer, TestJobRunnerService testJobRunnerService1) {
    ...
    this.testJobRunnerService = testJobRunnerService1;
  }
  ...
  public ResponseEntity<Void> postTenant(TenantAttributes tenantAttributes) {
    ...
    if (tenantInit.getStatusCode() == HttpStatus.NO_CONTENT) {
      try {
        ...
        //test
        testJobRunnerService.runTestJob();
